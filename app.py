...
with tabs[0]:
    ...
    if tax_status:
        # ✅ Pushed back to the exact location requested
        ...
        if not cfdi_data:
            ...
            # 🔥 Push to session_state so upgraded sat_views can pick it up dynamically
            ...
            # 🔥 Push to session_state so upgraded sat_views can pick it up dynamically
            st.session_state["top10_clientes_df"] = df_customers
            st.session_state["top10_proveedores_df"] = df_suppliers
